define(["modules/helpers"], function (helpers) {
  ...
  var fieldEditTemplate = _.template(
    '<label><div class="heading-small"><%=label%></div><input type="text" name="<%=name%>" data-entity="page" value="<%- value %>"></label>'
  );
