...
urlpatterns = [
    ...
    path('bundle/<uuid:bundle_id>/', ApplicationBundleDocumentsFormView.as_view(), name='appbundleedit'),
    path('bundle/<uuid:bundle_id>/remove/document/<uuid:document_id>/', ApplicationBundleDocumentsFormView.as_view(), name='appbundledeldoc'),
]
