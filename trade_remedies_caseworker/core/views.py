...
class TwoFactorView(TemplateView, LoginRequiredMixin, TradeRemediesAPIClientMixin):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            request.session['twofactor_error'] = 'The code you entered is incorrect. Retry or resend code.'
            request.session.modified = True
            return redirect('/')
...
class ForgotPasswordView(TemplateView, TradeRemediesAPIClientMixin):
    ...
    def get(self, request, *args, **kwargs):
        return render(request, 'forgot_password.html', {
            'requested': 'requested' in request.GET
        })
...
class SystemParameterSettings(LoginRequiredMixin, GroupRequiredMixin, TemplateView, TradeRemediesAPIClientMixin):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'settings/system_parameters.html', {
            'body_classes': "full-width",
...
class FeedbackFormsView(LoginRequiredMixin, GroupRequiredMixin, TemplateView, TradeRemediesAPIClientMixin):
    groups_required = SECURITY_GROUPS_TRA_ADMINS
...
class FeedbackFormExportView(LoginRequiredMixin, GroupRequiredMixin, TemplateView, TradeRemediesAPIClientMixin):
    groups_required = SECURITY_GROUPS_TRA_ADMINS
