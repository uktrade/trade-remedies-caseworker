...
class PartiesView(CaseBaseView):
    ...
    def add_page_data(self):
        ...
        return {
            "caseworker_invitations": caseworker_invitations,
            "party_types": parties,
...
class SubmissionsView(CaseBaseView):
        ...
        for role in all_roles:
            ...
            if role.get("key") == selected_tab or role.get("allow_cw_create"):
                ...
                for party in parties:
                    ...
                    party_submissions = submissions_by_party.get(party["id"], []) + empty_submissions
    ...
    def divide_submissions(self, submissions):
        ...
        for submission in submissions:
            ...
            elif not get(submission, "status/draft") or get(submission, "type/key") == "application":
    ...
    def add_page_data(self):
        ...
        if not submission_by_type.get("application") and submission_by_type.get("ex officio application"):
...
class SubmissionNotifyView(CaseBaseView):
    ...
    def get(self, request, case_id, submission_id, *args, **kwargs):
        ...
        elif notify_sys_param_name == "NOTIFY_QUESTIONNAIRE":
            email = None
        else:
        ...
        if item == "contacts":
            ...
            for invitation in all_case_invitations:
                if invitation.authorised_signatory:
                    authorised_contact_to_invitation[invitation.authorised_signatory.id] = (
                        invitation
                    )
